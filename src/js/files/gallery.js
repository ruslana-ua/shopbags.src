	...
	galleries.forEach(gallery => {
		galleyItems.push({
			...
			galleryClass: lightGallery(gallery, {
				hideBarsDelay: false, // Отключение автоматического скрытия элементов на мобильных устройствах
				// isMobile:undefined,
				toolbar: true,        // Включение панели инструментов
				download: false, // Отключение опции загрузки
				counter: false,  // Отключение счетчика фотографий
				subHtml: false,  // Отключение отображения описания из alt
				appendSubHtmlTo: '.lg-item', // Предотвращение отображения описания из alt
				plugins: [ lgThumbnail],
				mobileSettings: {
					controls: true,
					showCloseIcon: true,
