(() => {
    var __webpack_modules__ = {
        ...
        786: (module, __unused_webpack_exports, __webpack_require__) => {
            "use strict";
            var qs = __webpack_require__(79).qs;
        ...
        747: (module, __unused_webpack_exports, __webpack_require__) => {
            ...
            var event = __webpack_require__(79).f0;
            var css = __webpack_require__(79).AH;
            var add = __webpack_require__(79).WQ;
            var has = __webpack_require__(79).zy;
            var rm = __webpack_require__(79).rm;
            var clone = __webpack_require__(79).o8;
            var qs = __webpack_require__(79).qs;
            var _baron = baron;
            ...
            baron.version = "3.0.1";
            baron.prototype.autoUpdate = __webpack_require__(582)(scopedWindow);
            baron.prototype.fix = __webpack_require__(197);
            baron.prototype.controls = __webpack_require__(786);
 ...
 */
    ...
    (() => {
        ...
        function initializeBaron() {
            if (window.matchMedia("(max-width: 991.98px)").matches) baronElementsH.forEach((function(element) {
                if (!element.dataset.baronInitialized) {
                    const baronInstance = core({
                        direction: "h",
                        root: element,
        ...
        class SelectConstructor {
            ...
            optionAction(selectItem, originalSelect, optionItem) {
                ...
                if (!selectOptions.classList.contains("_slide")) {
                    ...
                    this.setSelectTitleValue(selectItem, originalSelect);
                    if (originalSelect.value) selectItem.classList.add(this.selectClasses.classFormValid); else selectItem.classList.remove(this.selectClasses.classFormValid);
            ...
            selectChange(e) {
                ...
                this.selectBuild(originalSelect);
                if (originalSelect.value) originalSelect.parentElement.classList.add(this.selectClasses.classFormValid); else originalSelect.parentElement.classList.remove(this.selectClasses.classFormValid);
                this.setSelectChange(originalSelect);
            }
        ...
        function initSliders() {
            ...
            if (productSliders) productSliders.forEach((function(productSlider) {
            ...
            if (reviewsSlider) new swiper_core_Swiper(".reviews__slider", {
...
***************************************************************************** */
        ...
        window.addEventListener("DOMContentLoaded", (function() {
            ...
            function setPlaceholder() {
                if (window.innerWidth > 991.98) var placeholderText = placeholderElement.dataset.desktop; else placeholderText = placeholderElement.dataset.mobile;
                if (inputField && placeholderText) inputField.setAttribute("placeholder", placeholderText);
            }
        ...
        if (includeElement) document.documentElement.classList.add("wh");
        ...
        function executeGotoBlock() {
            gotoblock_gotoBlock(".product-reviews", true, 200);
        }
